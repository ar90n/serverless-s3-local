...
$ npm install
$ npm -w simple-event-python run start
```

## Send a request
```
$ AWS_ACCESS_KEY_ID=S3RVER AWS_SECRET_ACCESS_KEY=S3RVER aws --endpoint http://localhost:8000 s3 cp ./1234.txt s3://local-bucket/1234.txt
{
